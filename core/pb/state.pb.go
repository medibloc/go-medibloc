...
func (*Account) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_18272434a9c88000, []int{0}
}
...
func (*AliasAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_18272434a9c88000, []int{1}
}
...
func (*DataState) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_18272434a9c88000, []int{2}
}
...
func (*Record) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_18272434a9c88000, []int{3}
}
...
func (*Certification) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_18272434a9c88000, []int{4}
}
...
func (*Alias) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_18272434a9c88000, []int{5}
}
...
func init() { proto.RegisterFile("state.proto", fileDescriptor_state_18272434a9c88000) }

var fileDescriptor_state_18272434a9c88000 = []byte{
